...
/**
* 请先运行ShanXiaoyan.sql 测试完需要还原数据库中的region和address
**/
...
public class ShanXiaoyanTest {
    ...
    public void addAddress5() throws Exception{
        ...
        byte[] responseString1 = manageClient.delete().uri("localhost:8080/shops/1/regions/302")
    ...
    public void updateAddress1() throws Exception{
        ...
        byte[] responseString = mallClient.put().uri("localhost:8080/addresses/3")
                .header("authorization", token)
                .bodyValue(requireJson)
                .exchange()
    ...
    public void updateAddress2() throws Exception{
        ...
        byte[] responseString = mallClient.put().uri("localhost:8080/addresses/1")
                .header("authorization", token)
                .bodyValue(requireJson)
                .exchange()
                .expectStatus().isNotFound()
    ...
    public void updateAddress3() throws Exception{
        ...
        byte[] responseString1 = manageClient.delete().uri("localhost:8080/shops/1/regions/305")
                .header("authorization", token1)
                .exchange()
                .expectStatus().isOk()
                .expectBody()
    ...
    public void addRegion1() throws Exception{
        ...
        byte[] responseString = manageClient.post().uri("localhost:8080/shops/1/regions/-1/subregions")
                .header("authorization", token)
                .bodyValue(requireJson)
                .exchange()
                .expectStatus().isNotFound()
    ...
    public void addRegion2() throws Exception{
        ...
        String token = this.adminLogin("13088admin", "123456");
        byte[] responseString1 = manageClient.delete().uri("localhost:8080/shops/1/regions/104")
                .header("authorization", token)
                .exchange()
                .expectStatus().isOk()
                .expectBody()
        ...
        byte[] responseString2 = manageClient.post().uri("localhost:8080/shops/1/regions/104/subregions")
                .header("authorization", token)
                .bodyValue(requireJson)
                .exchange()
                .expectStatus().isBadRequest()
    ...
    public void diableRegion1() throws Exception {
        ...
        byte[] responseString = manageClient.delete().uri("localhost:8080/shops/1/regions/-1")
                .header("authorization", token)
                .exchange()
                .expectStatus().isNotFound()
                .expectBody()
    ...
    public void diableRegion2() throws Exception {
        ...
        byte[] responseString = manageClient.delete().uri("localhost:8080/shops/1/regions/301")
                .header("authorization", token)
                .exchange()
                .expectStatus().isOk()
                .expectBody()
        ...
        byte[] responseString2 = manageClient.post().uri("localhost:8080/shops/1/regions/301/subregions")
                .header("authorization", token)
    ...
    public void setAsDefault3() throws Exception {
        ...
        byte[] responseString = mallClient.put().uri("localhost:8080/addresses/2/default").header("authorization", token)
                .exchange()
                .expectStatus().isForbidden()
                .expectHeader().contentType("application/json;charset=UTF-8")
                .expectBody()
    ...
    public void updateRegion1() throws Exception{
        ...
        byte[] responseString = manageClient.put().uri("localhost:8080/shops/1/regions/-1")
                .header("authorization", token)
                .bodyValue(requireJson)
                .exchange()
                .expectStatus().isNotFound()
    ...
    public void updateRegion2() throws Exception{
        ...
        String token = this.adminLogin("13088admin", "123456");
        byte[] responseString1 = manageClient.delete().uri("localhost:8080/shops/1/regions/303")
                .header("authorization", token)
                .exchange()
                .expectStatus().isOk()
                .expectBody()
        ...
        byte[] responseString2 = manageClient.put().uri("localhost:8080/shops/1/regions/303")
                .header("authorization", token)
                .bodyValue(requireJson)
                .exchange()
                .expectStatus().isBadRequest()
    ...
    public void getRegion1() throws Exception{
        ...
        byte[] responseString = manageClient.get().uri("localhost:8080/regions/-1/ancestor")
                .header("authorization", token)
                .exchange()
                .expectStatus().isNotFound()
                .expectBody()
    ...
    public void getRegion2() throws Exception{
        ...
        String token = this.adminLogin("13088admin", "123456");
        byte[] responseString1 = manageClient.delete().uri("localhost:8080/shops/1/regions/304")
                .header("authorization", token)
                .exchange()
                .expectStatus().isOk()
                .expectBody()
        ...
        byte[] responseString2 = manageClient.get().uri("localhost:8080/regions/304/ancestor")
                .header("authorization", token)
                .exchange()
                .expectStatus().isBadRequest()
                .expectBody()
