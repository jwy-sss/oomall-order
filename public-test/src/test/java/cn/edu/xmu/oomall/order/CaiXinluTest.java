...
public class CaiXinluTest {
    ...
    public void getRefundTest3() throws Exception{
        String token = this.login("13088admin", "123456");
        byte[] responseString =
                mallClient.get().uri("/aftersales/{id}/refunds",2)
                        .header("authorization", token)
                        .exchange()
    ...
    public void changeFreightModel1() throws Exception
    {
        ...
        byte[] responseString =
                mallClient.put().uri("/shops/{shopId}/freightmodels/{id}",295,88888)
                        .header("authorization",token)
    ...
    public void changeFreightModel3() throws Exception
    {
        ...
        byte[] responseString =
                mallClient.put().uri("/shops/{shopId}/freightmodels/{id}",295,99999)
                        .header("authorization",token)
                        .bodyValue(freightJson)
                        .exchange()
                        .expectStatus().isOk()
    ...
    public void changePieceFreightModel1() throws Exception
    {
        ...
        String freightJson = "{\n" +
                ...
                "}";
        byte[] responseString =
                mallClient.put().uri("/shops/{shopId}/pieceItems/{id}",295,55555)
                        .header("authorization",token)
                        .bodyValue(freightJson)
                        .exchange()
                        .expectStatus().isOk()
    ...
    public void changeWeightFreightModel1() throws Exception
    {
        ...
        String freightJson = "{\n" +
                ...
                "}";
        byte[] responseString =
                mallClient.put().uri("/shops/{shopId}/weightItems/{id}",295,55555)
                        .header("authorization",token)
                        .bodyValue(freightJson)
                        .exchange()
                        .expectStatus().isOk()
    ...
    public void calculateFreight() throws Exception {
        ...
        String json = "[{\"count\":6,\"skuId\":10001},{\"count\":2,\"skuId\":10002},{\"count\":1,\"skuId\":10003}]";
        byte[] responseString = manageClient.post().uri("/region/2/price").header("authorization", token)
                .bodyValue(json)
                .exchange()
        ...
        String expectedResponse = "{\"errno\":0,\"errmsg\":\"成功\",\"data\":288}";
