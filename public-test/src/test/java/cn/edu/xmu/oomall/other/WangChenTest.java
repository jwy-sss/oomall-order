...
public class WangChenTest {
    ...
    public void userTest1() throws Exception {
        ...
        body.put("password", "Aa1245&31d");
        body.put("birthday", "2020-12-09");
        body.put("mobile", "11154874631");
        body.put("email", "1448875415@kkkk.com");
        body.put("gender", 0);
        ...
        log.debug("尝试登录");
        userLogin("12457487789","Aa1245&31d");
    }
    ...
    public void onlineShareActivity1() throws Exception {
        ...
        byte[] responseString = manageClient.put().uri("/shops/0/shareactivities/304402/online").header("authorization", token)
                .exchange()
                .expectStatus().isOk()
    ...
    public void onlineShareActivity2() throws Exception {
        ...
        byte[] responseString = manageClient.put().uri("/shops/0/shareactivities/305687/online").header("authorization", token)
                .exchange()
                .expectStatus().isOk()
                .expectHeader().contentType("application/json;charset=UTF-8")
                .expectBody()
    ...
    public void addSharesTest1() throws Exception {
        String token = userLogin("12457487789","Aa1245&31d");
        byte[] responseString = mallClient.post().uri("skus/300/shares").header("authorization", token)
                ...
                .expectBody()
                .returnResult().getResponseBodyContent();
        String expectedResponse = "{\"quantity\":0,\"sku\":{\"originalPrice\":68000,\"price\":68000,\"imageUrl\":\"http://47.52.88.176/file/images/201612/file_58621fe110292.jpg\",\"name\":\"+\",\"disabled\":0,\"id\":300,\"inventory\":1}}";
    ...
    public void addSharesTest2() throws Exception {
        ...
        byte[] responseString = mallClient.post().uri("skus/400/shares").header("authorization", token)
                ...
                .expectBody()
                .returnResult().getResponseBodyContent();
        String expectedResponse = "{\"quantity\":0,\"sku\":{\"originalPrice\":12000,\"price\":12000,\"imageUrl\":\"http://47.52.88.176/file/images/201702/file_58a10d2f39fd6.jpg\",\"name\":\"+\",\"disabled\":0,\"id\":400,\"inventory\":1}}";
    ...
    public void usergetshares1() throws Exception {
        ...
        byte[] responseString = mallClient.get().uri("shares").header("authorization", token)
                ...
                .expectBody()
                .returnResult().getResponseBodyContent();
        String expectedResponse = "[{\"quantity\":0,\"sku\":{\"originalPrice\":68000,\"price\":68000,\"imageUrl\":\"http://47.52.88.176/file/images/201612/file_58621fe110292.jpg\",\"name\":\"+\",\"disabled\":0,\"id\":300,\"inventory\":1}},{\"quantity\":0,\"sku\":{\"originalPrice\":12000,\"price\":12000,\"imageUrl\":\"http://47.52.88.176/file/images/201702/file_58a10d2f39fd6.jpg\",\"name\":\"+\",\"disabled\":0,\"id\":400,\"inventory\":1}}]";
    ...
    public void usergetshares4() throws Exception {
        String token = userLogin("45420889878","123456");
        byte[] responseString = mallClient.get().uri("shares?beginTime=2020-12-22 1:2:1 &endTime=2012-12-44 1:2:1 ").header("authorization", token)
                .exchange()
                .expectStatus().isOk()
                .expectHeader().contentType("application/json;charset=UTF-8")
                .expectBody()
