...
public class ChenPinzhenTest {
    ...
    private String login(String userName, String password) throws Exception {
        ...
        byte[] ret = loginClient.post().uri("/privilege/privileges/login").bodyValue(requireJson).exchange()
                .expectStatus().isOk()
                .expectBody()
    ...
    public void updateSpu1() throws Exception {
        ...
        String expectedResponse = "{\n" +
                ...
                "}";
        JSONAssert.assertEquals(expectedResponse, responseString, false);
        byte[] queryResponseString = mallClient.get().uri("/goods/spus/20683")
                .exchange()
                .expectStatus().isOk()
                .expectBody()
                .jsonPath("$.errno").isEqualTo(ResponseCode.OK.getCode())
    ...
    public void onshelfSku1() throws Exception {
        String token = this.login("13088admin", "123456");
        byte[] ret = manageClient.put()
                .uri("/goods/shops/0/skus/20680/onshelves")
                .header("authorization", token)
                .exchange()
                .expectStatus().isOk()
                .expectBody()
