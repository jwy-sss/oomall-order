...
public class SongRunhanTest {
    ...
    public void addFlashSaleActivity1() throws Exception{
        ...
        WebTestClient.RequestHeadersSpec res = manageClient.post().uri("/shops/0/timesegments/0/flashsales").header("authorization",token).bodyValue(requestJson);
...
//                .getResponseBodyContent();
    ...
    public void delFlashSale() throws Exception {
        ...
        /*
          继续删，应当报错
         */
        mallClient.delete().uri("/shops/0/flashsales/0").header("authorization",token).exchange()
